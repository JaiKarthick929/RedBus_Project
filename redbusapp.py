...
# kerala bus
lists_k=[]
df_k=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_Kerala.csv")
for i,r in df_k.iterrows():
    lists_k.append(r["Route_name"])

#Andhra bus
lists_A=[]
df_A=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_Andhera.csv")
for i,r in df_A.iterrows():
    lists_A.append(r["Route_name"])

#Telungana bus
lists_T=[]
df_T=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_Telegena.csv")
for i,r in df_T.iterrows():
    lists_T.append(r["Route_name"])

#Goa bus
lists_g=[]
df_G=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_Goa.csv")
for i,r in df_G.iterrows():
    lists_g.append(r["Route_name"])

#Rajastan bus
lists_R=[]
df_R=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_Rajasthan.csv")
...
# South bengal bus 
lists_SB=[]
df_SB=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_SouthBengal.csv")
for i,r in df_SB.iterrows():
    lists_SB.append(r["Route_name"])

# Haryana bus
lists_H=[]
df_H=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_Haryana.csv")
for i,r in df_H.iterrows():
    lists_H.append(r["Route_name"])

#Assam bus
lists_AS=[]
df_AS=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_Assam.csv")
for i,r in df_AS.iterrows():
    lists_AS.append(r["Route_name"])

#UP bus
lists_UP=[]
df_UP=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_UttraPradesh.csv")
for i,r in df_UP.iterrows():
    lists_UP.append(r["Route_name"])

#West bengal bus
lists_WB=[]
df_WB=pd.read_csv(r"C:\Users\J\Desktop\GUVI\Project\RedBus\Bus_Routes_and_Links\df_WestBengal.csv")
...
web=option_menu(menu_title="🚌Government Bus",
                options=["Bus Availability"],
                icons=["routes"],
...
if web == "Bus Availability":
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = pymysql.connect(host="localhost", user="root", password="Karthick@04", database="RED_BUS_DETAILS")
